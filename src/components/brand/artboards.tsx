  ...
  return (
    <div className="sheet" style={{ aspectRatio: "8.5 / 11" }}>
      ...
      <div className="mt-auto">
        ...
        <p className="mt-2 t-data text-[0.75rem] text-accent-soft" style={{ color: "#b8bcc4" }}>
      ...
      <div className="mt-7 flex items-end justify-between border-t border-line pt-5">
        ...
        <p className="t-data text-right text-[0.6rem] leading-relaxed text-text3" style={{ color: "#5f5f66" }}>
          {DIVISION_LINE}
        </p>
      </div>
    </div>
      ...
      <div className="mt-8 border-t border-line">
        {rows.map(([k, val]) => (
          <div key={k} className="grid grid-cols-[88px_1fr] gap-3 border-b border-line py-2.5">
            <span className="t-data text-[0.6rem] text-text3 uppercase" style={{ color: "#5f5f66" }}>{k}</span>
            <span className="t-data text-[0.68rem] text-ink">{val}</span>
          </div>
        ))}
      </div>
      <p className="mt-auto t-data text-[0.58rem] leading-relaxed text-text3" style={{ color: "#5f5f66" }}>
        {DIVISION_LINE}
      </p>
    </div>
  );
...
export function PlateFrame() {
  return (
    <div
      className="relative mx-auto rounded-[10px] border-[6px] border-[#1d1d20] bg-transparent"
    ...
    >
      ...
      <div className="absolute inset-[10px] grid place-items-center rounded border border-line/50">
        <span className="t-data text-[0.6rem] text-text3" style={{ color: "#5f5f66" }}>PLATE</span>
      </div>
    </div>
  );
}
...
export function ShopSign({ division }: { division: DivisionKey }) {
  return (
    <div className="flex items-center justify-center gap-5 border border-line bg-[#0e0e10] px-10 py-12">
...
export function SocialSet() {
  return (
    <div className="grid grid-cols-[96px_1fr] items-start gap-6">
      <div className="grid aspect-square w-24 place-items-center rounded-full bg-[#0e0e10] outline outline-1 outline-line">
  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2">
      ...
      <div className="sheet !justify-between !p-6" style={{ aspectRatio: "3.5 / 2" }}>
        ...
        <p className="t-data text-[0.58rem] leading-relaxed text-text3" style={{ color: "#5f5f66" }}>
